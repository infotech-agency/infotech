...
//  * -------------------------------------------------------------
//  * Recreated from the reference design using this project's own
//  * design tokens (globals.css: --primary, --secondary, gradient-*,
//  * shadow-premium, bg-grid, etc.) + Poppins font.
//  *
//  * Requires: lucide-react  ->  npm install lucide-react
//  *
//  * Usage:
//  *   import SmartStrategiesSection from "@/components/SmartStrategiesSection";
//  *   <SmartStrategiesSection />
//  */
...
//   { icon: ShoppingCart, label: "More Sales" },
...
// /** Coordinates for the desktop diagram, based on a 1200x620 canvas.
//  *  NOTE: SVG path "d" data only accepts raw numbers (viewBox units),
//  *  never percentage strings — that was the earlier bug that hid the lines. */
// const CANVAS_W = 1200;
// const CANVAS_H = 620;
...
// /** New accent gradient: green -> rose */
// const GRADIENT = "linear-gradient(135deg, #6BAB44 0%, #F43F5E 100%)";
...
//         </p>
//         <h2
//           className="mt-2 text-balance text-3xl font-extrabold italic sm:text-4xl md:text-5xl"
//           style={{
...
//           >
//             <div
//               className="relative flex h-full w-full items-center justify-center rounded-full text-center shadow-glow ring-8 ring-background"
//               style={{ backgroundImage: GRADIENT }}
//             >
//               <div className="absolute -top-6 left-1/2 flex h-14 w-14 -translate-x-1/2 items-center justify-center rounded-full bg-card shadow-premium">
//                 <Megaphone className="h-6 w-6 text-[#F43F5E]" />
//               </div>
//               <div className="px-6">
...
//         <div
//           className="mx-auto flex h-40 w-40 flex-col items-center justify-center rounded-full text-center shadow-glow"
//           style={{ backgroundImage: GRADIENT }}
//         >
//           <Megaphone className="mb-2 h-6 w-6 text-white" />
...
export default function SmartStrategiesSection() {
  return (
    <section className="relative overflow-hidden bg-background py-16 sm:py-20">
      ...
      <div className="relative mx-auto mt-14 hidden max-w-6xl px-4 lg:block">
        ...
        >
          ...
          >
            ...
            >
              {/* Replace the src below with your mike/horn image */}
              <img
      ...
      {/* Mobile / tablet stacked version */}
      <div className="relative mx-auto mt-10 max-w-md space-y-4 px-4 lg:hidden">
        {/* Center circle with image on mobile */}
        <div
