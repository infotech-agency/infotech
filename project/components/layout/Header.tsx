...
//                                     : 'text-muted-foreground hover:bg-white/60 hover:text-black'
//                                 )}
//                               >
...
//                           <Link
//                             href="/contact"
//                             className="flex items-center justify-between text-sm font-semibold text-black transition-colors hover:text-electric"
//                           >
