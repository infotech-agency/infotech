...
// //               <div className="group h-full rounded-2xl border border-border bg-white p-8 text-center shadow-premium transition-all hover:-translate-y-2 hover:shadow-premium-lg">
...
// // TypeScript interface (agar aap TS use kar rahe hain, nahi toh ise hata sakte hain)
...
//   suffix: string;
//   icon: string;
//   description?: string; // Agar API se badme description bhi bhejna ho
// }
...
//           // Sort order ke hisab se data ko arrange karne ke liye (optional)
...
//             {[...Array(4)].map((_, index) => (
//               <div key={index} className="h-48 animate-pulse rounded-2xl bg-white/50 p-8 shadow-premium" />
//             ))}
//           </div>
//         ) : (
//           // Dynamic Data Content with Animation
//           <Stagger className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
//             {achievements.map((item) => (
//               <StaggerItem key={item._id}>
//                 <div className="group h-full rounded-2xl border border-border bg-white p-8 text-center shadow-premium transition-all hover:-translate-y-2 hover:shadow-premium-lg">
//                   <div className="text-5xl font-bold text-[#2D3862]">
//                     {/* Aapka purana Counter component same integration ke sath */}
//                     <Counter value={item.value} suffix={item.suffix} />
//                   </div>
//                   <div className="mt-3 text-lg font-semibold text-brand">
//                     {item.label}
